...
test('UIQ should match script results', (t) => {
	const uiqMap = ssim(sampleCsv.lena, sampleCsv.lena02876, k0Options);

	const uiqOut = round(mean2d(uiqMap));

	t.equal(uiqOut, 0.46544);
	t.end();
});
